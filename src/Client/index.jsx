...
export default class Client extends React.Component {
    ...
    google = () => {
        return ({
            'logo': <svg width="80" height="96" viewBox="0 0 50 36" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M23.4 46.9c-12.5 0-23-10.2-23-22.7s10.5-22.7 23-22.7c6.9 0 11.9 2.7 15.6 6.3l-4.4 4.4c-2.7-2.5-6.3-4.4-11.2-4.4C14.2 7.7 7.1 15 7.1 24.2c0 9.1 7.1 16.5 16.3 16.5 5.9 0 9.3-2.4 11.5-4.5 1.8-1.8 2.9-4.3 3.4-7.8H23.5v-6.2h20.7c.2 1.1.3 2.4.3 3.9 0 4.7-1.3 10.4-5.4 14.5-3.9 4.1-9 6.3-15.7 6.3zm52.7-14.6c0" fill="white" /></svg>,
        ...
        return (
            ...
            <div className="flex flex-col px-16 py-16 xl:px-0">
                ...
                <div className="grid grid-row gap-4">
                    ...
                    <ClientComponents logo={this.apple().logo} company="Apple, inc." position={this.apple().position} />

                    <ClientComponents logo={this.google().logo} company="Google, inc." position={this.google().position} />
